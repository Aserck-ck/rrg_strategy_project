...
from dataset import prepare_sw2_dataloaders
...
def train_model(continue_training,e_x=21):
    ...
    model_name = f'sw_level2_gat_gru{predict_window}'
    ...
    model_checkpoint_path = f"./gnn_models/checkpoint/{model_name}_best_model.pth"
    ...
    train_loader, val_loader, test_loader, train_dataset, val_dataset, test_dataset, train_sampler = (
        prepare_sw2_dataloaders(time_window, predict_window, batch_size,
    ...
    for epoch_idx in range(epochs):
        ...
        with tqdm(train_loader, desc=f"Epoch {epoch_idx + 1}/{epochs} [训练]") as pbar:
            ...
            for i, (batch_x, _) in enumerate(pbar):
                ...
                single_loss= seq_loss**2+tail_loss**2
