...
from dataset import prepare_predict_dataset
...
def test_model():
    ...
    z_score_feature, log_feature, origin_feature, stamp_feature = get_config()

    test_dataset = (
        prepare_predict_dataset(time_window, z_score_feature, log_feature, origin_feature, stamp_feature))
