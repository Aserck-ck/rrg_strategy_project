...
def train_model(continue_training,train_size,train_step,e_x=21):
    ...
    model_name = f'sw_level1_w_gat_gru{predict_window}_{hidden_size}'
...
if __name__ == "__main__":
    ...
    for train_size in range(3):
        train_model(False, train_size, 3, 15)
