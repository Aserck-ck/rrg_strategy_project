...
def get_sw_level1_ratio(ts_code='all', frequency='daily'):
    '''Retrieve JDK RS ratio of SW level1 sectors. By default retrieve all
...
def get_sw_level1_momentum(ts_code='all', frequency='daily'):
    '''Retrieve JDK RS momentum of SW level 1 sectors. By default retrieve all
