...
def get_sw_level2_rank(ts_code='all', frequency='daily'):
    '''Retrieve crowdedness rank of SW level2 sectors. By default retrieve all. 
...
def get_sw_level2_percentile(ts_code='all', frequency='daily'):
    '''Retrieve crowdedness percentile of SW level 2 sectors. By default retrieve all. 
    If a specific stock data is wanted, input the corresponding
    wind_code. Frequency is by default daily, and weekly frequency can also 
    be admitted.'''
    file_path = os.path.abspath(os.path.dirname(__file__))
...
def get_sw_level2_crowdedness(ts_code='all', frequency='daily'):
    '''Retrieve crowdedness of SW level 2 sectors. By default retrieve all. 
    If a specific stock data is wanted, input the corresponding
    wind_code. Frequency is by default daily, and weekly frequency can also 
    be admitted.'''
    file_path = os.path.abspath(os.path.dirname(__file__))
